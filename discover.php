...
elseif(isset($_GET['popular-playlists']))
{
	...
	else
	{
		...
		if($i > $initial_results) echo '<div class="show_all_list_items_div actions_div" data-actions="show_all_list_items" data-items="list_item_div" data-highlightclass="light_grey_highlight" onclick="void(0)"><div><div><div class="img_div img_24_div all_24_img_div"></div></div><div>Show all playlists</div></div></div>';
...
else
{
	...
	echo '
		...
		<div class="list_header_div"><div><div>DISCOVER</div></div><div></div></div>
		...
		<div class="list_item_div">
		<div title="New singles" class="list_item_main_div actions_div" data-actions="change_activity" data-activity="playlists" data-subactivity="browse" data-args="uri=spotify:user:spotify:playlist:5JOn3LSfpbCrOQ7azB4S6C" onclick="void(0)">
		<div class="list_item_main_inner_div">
		<div class="list_item_main_inner_icon_div"><div class="img_div img_24_div track_24_img_div"></div></div>
		<div class="list_item_main_inner_text_div"><div class="list_item_main_inner_text_upper_div">New singles</div></div>
		</div>
		</div>
		</div>
