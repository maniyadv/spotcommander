...
else
{
	...
	$activity['actions'][] = array('action' => array('Clear', 'remove_32_img_div'), 'keys' => array('actions'), 'values' => array('clear_queue'));
	...
	else
	{
		...
		foreach($tracks as $track)
		{
			...
			echo '
				...
				<div title="Remove" class="actions_div" data-actions="remove_from_queue" data-id="' . $id . '" data-sortorder="' . $sortorder . '" data-highlightclass="dark_grey_highlight" onclick="void(0)"><div class="img_div img_24_div remove_24_img_div"></div></div>
				</div>
				</div>
				</div>
			';
