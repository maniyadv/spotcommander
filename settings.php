...
<div class="setting_div">
<div class="setting_text_div"><div>Persistent notification</div><div>Show persistent notification with playback controls when in background. Android 4.1 and up.</div></div>
...
<div class="setting_text_div"><div>Shake to skip</div><div>Shake device to play next track.</div></div>
<div class="setting_edit_div"><input type="checkbox" class="setting_checkbox" name="settings_shake_to_skip"<?php echo setting_checkbox_status('settings_shake_to_skip'); ?>></div>
</div>
...
<div class="setting_text_div"><div>Notifications</div><div>Notify when track changes. After checking the checkbox, you must allow notifications in your browser.</div></div>
<div class="setting_edit_div"><input type="checkbox" class="setting_checkbox" name="settings_notifications"<?php echo setting_checkbox_status('settings_notifications'); ?>></div>
</div>
