...
else
{
	...
	$actions_dialog['actions'][] = array('text' => 'Play artist', 'keys' => array('actions', 'uri'), 'values' => array('hide_dialog play_artist', $artist_uri));
	...
	$actions_dialog['actions'][] = array('text' => 'Share', 'keys' => array('actions', 'uri'), 'values' => array('hide_dialog share_uri', rawurlencode(uri_to_url($album_uri))));
