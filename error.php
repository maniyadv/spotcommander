...
$files = get_external_files(array(project_website . 'api/1/error/?version=' . rawurlencode(number_format(project_version, 1)) . '&error_code=' . rawurlencode($code) . '&uname=' . rawurlencode($sysinfo['uname']) . '&ua=' . rawurlencode($sysinfo['ua'])));
