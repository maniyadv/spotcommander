...
$files = get_external_files(array(project_website . 'error.php?version=' . rawurlencode(project_version) . '&error_code=' . rawurlencode($code) . '&uname=' . rawurlencode($sysinfo['uname']) . '&ua=' . rawurlencode($sysinfo['ua'])));
...
<div><a href="http://www.olejon.net/code/spotcommander/?how_to_install" target="_blank">Help</a></div>
<div><a href="http://www.olejon.net/code/spotcommander/?report_issue" target="_blank">Report</a></div>
</div>
