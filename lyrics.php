...
$count = get_db_count('lyrics-cache', "SELECT COUNT(*) as count FROM lyrics WHERE md5='" . md5($uri) . "'");

if($count == 1)
{
	$lyrics = get_db_rows('lyrics-cache', "SELECT * FROM lyrics WHERE md5='" . md5($uri) . "'", array('lyrics'));
