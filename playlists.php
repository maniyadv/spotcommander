...
elseif(isset($_GET['add']))
{
	...
	echo '
		...
		<div>
		<div>
		<div class="card_div actions_div" data-actions="confirm_add_spotify_playlists" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div add_24_img_div"></div></div><div class="card_text_div"><div><b>Add from Spotify</b></div><div>Add your playlists from Spotify. This can take some time because playlist names must be looked up on Spotify\'s servers</div></div></div>
		...
		<div>
		<div class="card_div actions_div" data-actions="change_activity" data-activity="playlists" data-subactivity="add-manually" data-args="" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div edit_24_img_div"></div></div><div class="card_text_div"><div>Add manually</div><div>Add playlists manually by copying Spotify URIs from Spotify or web pages. On Android you can share playlists to ' . project_name . ' from other apps.</div></div></div>
		</div>
		</div>
		</div>
	';
