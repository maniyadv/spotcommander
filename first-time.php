...
$activity['actions'] = array('icon' => array('OK, got it!', 'yes_32_img_div'), 'keys' => array('actions', 'activity', 'subactivity', 'args'), 'values' => array('replace_activity', 'playlists', '', ''));

?>

<div id="activity_inner_div" data-activitydata="<?php echo base64_encode(json_encode($activity)); ?>">

<div class="divider_div"><div><div>NOTES</div></div><div></div></div>

<ul>
<li>Learn how to use <?php echo project_name; ?> below</li>
<li>This information will only show once</li>
<li>You can find this information later on the <span class="actions_span" data-actions="open_external_activity" data-uri="<?php echo project_website; ?>?use" data-highlightclass="opacity_highlight" onclick="void(0)">wiki</span></li>
</ul>

<div class="divider_div"><div><div>BASIC NAVIGATION</div></div><div></div></div>
...
<div class="divider_div"><div><div>GESTURES</div></div><div></div></div>
...
<li>If motion gestures are enabled, shake to play next track</li>
</ul>

<div class="divider_div"><div><div>KEYBOARD SHORTCUTS</div></div><div></div></div>
