...
elseif(isset($_GET['import']))
{
	...
	echo '
		...
		<div class="cards_div cards_margin_div">
		<div>
		<div>
		<div class="card_div actions_div" data-actions="change_activity" data-activity="starred" data-subactivity="import-manually" data-args="" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div edit_24_img_div"></div></div><div class="card_text_div"><div><b>Import manually</b></div><div>Open the Spotify desktop client, go to "Starred", select all tracks (Ctrl + A), right click and choose "Copy Spotify URI". Tap here, paste the URIs in the field and save with the return key on the keyboard. Importing many tracks may take some time because metadata must be looked up on Spotify\'s servers.</div></div></div>
		</div>
		<div>
		<div class="card_div actions_div" data-actions="confirm_import_starred_spotify_tracks" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div import_24_img_div"></div></div><div class="card_text_div"><div>Import from Spotify</div><div>This is experimental and may not work. Importing manually is recommended. Importing many tracks may take some time because metadata must be looked up on Spotify\'s servers.</div></div></div>
		</div>
		</div>
		</div>
...
else
{
	...
	$activity['actions'][] = array('action' => array('Import tracks', 'import_32_img_div'), 'keys' => array('actions', 'activity', 'subactivity', 'args'), 'values' => array('change_activity', 'starred', 'import', ''));
