...
else
{
	...
	echo '
		...
		<div class="divider_div">TRACKS</div>

		<div class="list_div">
	';

	$tracks = get_db_rows('starred', "SELECT * FROM starred WHERE type='track' ORDER BY artist COLLATE NOCASE, title COLLATE NOCASE", array('artist', 'title', 'uri'));
	$albums = get_db_rows('starred', "SELECT * FROM starred WHERE type='album' ORDER BY artist COLLATE NOCASE, title COLLATE NOCASE", array('artist', 'title', 'uri'));
	...
	echo '
		...
		<div class="divider_div">ALBUMS</div>
