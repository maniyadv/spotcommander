...
elseif(isset($_GET['import']))
{
	...
	echo '
		...
		<li>Choose import manually above, paste the URIs in the field and save with the return key on the keyboard</li>
		<li>On Android you can share tracks to ' . project_name . ' from other apps</li>
		</ul>
